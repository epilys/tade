...
CREATE_UPDATE_LAST_MODIFIED_STORY_ON_INSERT_VOTE = """CREATE TRIGGER update_last_modified_story_on_insert_vote AFTER INSERT ON tade_vote FOR EACH ROW
BEGIN
    UPDATE tade_story
...
CREATE_UPDATE_LAST_MODIFIED_STORY_ON_UPDATE_VOTE = """CREATE TRIGGER update_last_modified_story_on_update_vote AFTER UPDATE ON tade_vote FOR EACH ROW
BEGIN
    UPDATE tade_story
...
CREATE_UPDATE_LAST_MODIFIED_STORY_ON_DELETE_VOTE = """CREATE TRIGGER update_last_modified_story_on_delete_vote AFTER DELETE ON tade_vote FOR EACH ROW
BEGIN
    UPDATE tade_story
    SET last_active = strftime ('%Y-%m-%d %H:%M:%f000', 'now')
WHERE
...
CREATE_INSERT = """CREATE TRIGGER tade_vote_insert AFTER INSERT ON tade_vote
                    ...
                    WHERE
                        id = NEW.story_id;
                        END;"""
CREATE_DELETE = """CREATE TRIGGER tade_vote_delete AFTER DELETE ON tade_vote
                    ...
                    WHERE
                        id = OLD.story_id;
                        END;"""
CREATE_INSERT_COMMENT = """CREATE TRIGGER tade_vote_insert_comment AFTER INSERT ON tade_vote
...
CREATE_DELETE_COMMENT = """CREATE TRIGGER tade_vote_delete_comment AFTER DELETE ON tade_vote
...
DROP_INSERT = """DROP TRIGGER tade_vote_insert;"""
DROP_DELETE = """DROP TRIGGER tade_vote_delete;"""
DROP_INSERT_COMMENT = """DROP TRIGGER tade_vote_insert_comment;"""
DROP_DELETE_COMMENT = """DROP TRIGGER tade_vote_delete_comment;"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("tade", "0074_user_exclude_filters"),
    ]
    operations = [
        migrations.RunSQL(
            sql=DROPS,
