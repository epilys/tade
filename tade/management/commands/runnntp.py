...
from tade.models import Story, Comment, User
from tade.mail import post_receive
from django.apps import apps

config = apps.get_app_config("tade")


class TadeAllStories(NNTPGroup):
...
class TadeNNTPServer(NNTPServer, collections.abc.Mapping):
    ...
    def __init__(self, *args: typing.Any, **kwargs: typing.Any) -> None:
        self.all: TadeAllStories = TadeAllStories(self)
        self._groups: typing.Dict[str, TadeAllStories] = {self.all.name: self.all}
        self.count: int = 0
        self.high: int = 0
        self.low: int = 0
...
class Command(BaseCommand):
    ...
    def handle(self, *args: typing.Any, **kwargs: typing.Any) -> None:
        ...
        TadeNNTPServer.allow_reuse_address = True
